package eu.sanjin.kurelic.paintingsgarage.photo.repository;
...
import static eu.sanjin.kurelic.paintingsgarage.photo.repository.PhotoSpecification.combineSpecifications;
import static eu.sanjin.kurelic.paintingsgarage.photo.repository.PhotoSpecification.findAllByAuthorIdIn;
import static eu.sanjin.kurelic.paintingsgarage.photo.repository.PhotoSpecification.findAllByPhotoIdIn;
import static eu.sanjin.kurelic.paintingsgarage.photo.repository.PhotoSpecification.findAllBySize;
import static eu.sanjin.kurelic.paintingsgarage.photo.repository.PhotoSpecification.findAllByUploadedAfterAndUploadedBefore;
