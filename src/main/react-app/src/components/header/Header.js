...
import {Button, Container, Form, FormControl, Image, InputGroup, Nav} from 'react-bootstrap'
  ...
  return (
    <Nav className="bg-light">
      <Container className="d-flex justify-content-between p-2">
        <Image className='my-2' src={logo} height={40}/>
        <Form className="mx-3 my-2 flex-grow-1" style={{maxWidth: '600px'}}>
          <InputGroup>
            <FormControl/>
